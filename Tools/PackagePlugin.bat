...
set BuildID=%4
set EnginePath=%~5
set PluginPath=%CD%\Plugins\Gunsmith
...
powershell.exe -executionpolicy bypass -file %CD%\Tools\EditVersionJson.ps1 %CD%\GunsmithExamples.uproject %EngineVersion% EngineAssociation
